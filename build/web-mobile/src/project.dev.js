...
cc.Class({
    ...
    _borderMovablePoints: function _borderMovablePoints(position) {
        ...
        if (this.moveType == AStarMoveType.EIGHT_DIRECTION) {
            // Top Left
            var topLeft = cc.p(position.x - 1, position.y - 1);
            if (hasTop && hasLeft) {
            ...
            // Top Right
            var topRight = cc.p(position.x + 1, position.y - 1);
            if (hasTop && hasRight) {
            ...
            // Bottom Left
            var bottomLeft = cc.p(position.x - 1, position.y + 1);
            ...
            // Bottom Right
            var bottomRight = cc.p(position.x + 1, position.y + 1);
...
cc._RFpop();
},{"AStar":"AStar","AStarMoveType":"AStarMoveType"}]},{},["AuthorFooter","TestMap","AStar","AStarMoveType","AStarStep"])
